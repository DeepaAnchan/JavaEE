...
/**
 * Servlet implementation class AddLeagueServletView
 */
public class AddLeagueServletView extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private List<String> l = null;
	LeagueDao sao = null;
	List<SharedLeague> users = null;
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (l != null) {
			out.println("please correct the below error(s)<br/>");
			for (String str : l) {
		...
		out.println("<div><a href='index.html'>Go To Home Page</a></div>");
